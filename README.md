...
1. **Общий список пользователей:** Просмотр списка всех клиентов (кто оплатил, а кто просрочил).
...
3. **Настройка авто-оплаты:** Изменение дня и времени рассылки прямо в боте.
